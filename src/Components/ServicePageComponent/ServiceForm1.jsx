...
const ServiceForm1 = () => {
 const API = import.meta.env.VITE_API
  ...
  console.log("service mark", serviceMarks);
  ...
  const handleFileUpload = async (e) => {
    ...
    // Append files
    totalFiles.forEach((file) => formData.append("activitiesFiles", file));
    ...
    try {
      const response = await axios.post(
        `${API}/api/activities/${designation}/`,
        formData,
        {
          headers: {
          ...
          <div className="checkbox-container px-6 mt-4 space-y-2">
            ...
            <div className="container-1 flex gap-2 items-center">
              <input
                ...
                onChange={(e) => {
                  // handleRoleChange(e.target.checked, "None");
                  handleNoneChange();
                }}
              />
        ...
        <div className="second-container col-span-2 text-center">
          ...
          <div className="h-[80%] flex items-center justify-center">
            <h1 className="text-[#646464]  text-lg">
              ...
              out of {serviceMarks?.activities}
            </h1>
          </div>
        </div>
      </div>
