...
const TeachingForm7 = () => {
  ...
  const [lakhsType, setLakhsType] = useState("");
  ...
  const handleLakhsTypeChange = async (value) => {
    try {
      ...
      setLakhsTypemark(response.data.finalMarks);
    } catch (error) {
      console.error(
          ...
          <div className="first-container pr-3 border-r border-gray-400 col-span-10">
            ...
            <div className="radio-button-container space-y-2 px-2 py-2 rounded-lg mt-2 text-[#646464] font-medium">
              <div className="input-1 flex items-center gap-2">
                <input
                  type="radio"
                  name="studentfeedbackl"
                  value="less than 1 lakh"
                  checked={selectedValue == "less than 1 lakh" ? true : false}
                  className="scale-125 accent-teal-400 cursor-pointer"
                  onChange={(e) => {
                    setSelectedValue("less than 1 lakh");
                    handleLakhsTypeChange("less than 1 lakh");
                  }}
                />
              ...
              <div className="input-1 flex items-center gap-2">
                <input
                  type="radio"
                  name="studentfeedbackh"
                  value="1-2 lakh"
                  checked={selectedValue == "1-2 lakh" ? true : false}
                  className="scale-125 accent-teal-400 cursor-pointer"
                  onChange={(e) => {
                    setSelectedValue("1-2 lakh");
                    handleLakhsTypeChange("1-2 lakh");
                  }}
                />
              ...
              <div className="input-1 flex items-center gap-2">
                <input
                  ...
                  className="scale-125 accent-teal-400 cursor-pointer"
                  checked={
                    selectedValue == "greater than 2 lakh" ? true : false
                  }
                  onChange={(e) => {
                    setSelectedValue("greater than 2 lakh");
                    handleLakhsTypeChange("greater than 2 lakh");
                  }}
                />
          ...
          <div className="second-container col-span-2 text-center">
            ...
            <div className="h-[80%] flex items-center justify-center">
              <h1 className="text-[#646464]  text-lg">
                ...
                out of {markData?.points?.fdpFunding}
              </h1>
            </div>
          </div>
        </div>
